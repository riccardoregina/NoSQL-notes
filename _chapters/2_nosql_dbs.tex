...
Differently from relational databases, the One-to-Many relationship is more nuanced: it is split into three variants, based on the given cardinalities of the two parts~\cite{}.
...
\begin{itemize}
    ...
    \item \textbf{One-to-Many Relationships:} Each element of the \q{many} side gets referenced in a list inside the \q{one} side. Each element of the \q{many} side has now its own document. 
        ...
        \begin{note}{}
            If we add a reference identifier of the product to the replacement part document, then this approach can also model Many-to-Many relationships.
        \end{note}
