...
\section{SPARQL}
% cite: https://www.w3.org/TR/sparql11-query/
...
\begin{definition}{Group Graph Pattern}
    ...
    It is \emph{arbitrarily} complex because it can contain just triple patterns --- in this case, it becomes a BGP --- as well as entire subqueries (\texttt{SELECT}-\texttt{WHERE}-...) and nested GPPs.
\end{definition}
